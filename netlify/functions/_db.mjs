...
export async function ensure() {
  ...
  await sql`alter table tickets add column if not exists photo_bytes bigint`;
  await sql`alter table tickets add column if not exists fuel_type text default ''`;
  await sql`alter table tickets add column if not exists paid_by_user boolean default false`;
