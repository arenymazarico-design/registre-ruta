...
const CACHE = 'registre-cache-v45';
...
self.addEventListener('fetch', (e) => {
  ...
  // Els fitxers principals (html/js/manifest) sempre frescos de la xarxa, sense cau HTTP.
  ...
  e.respondWith(
    fetch(shell ? new Request(req, { cache: 'no-store' }) : req)
      .then((res) => {
